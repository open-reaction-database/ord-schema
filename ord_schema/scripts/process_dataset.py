...
def run(args) -> tuple[Optional[set[str]], Optional[set[str]], Optional[set[str]]]:
    ...
    for file_status in inputs:
        ...
        if not args.no_validate and dataset is not None:
            ...
            validations.validate_datasets(datasets, args.write_errors)
