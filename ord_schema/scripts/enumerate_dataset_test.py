...
class EnumerateDatasetTest(absltest.TestCase):
    def setUp(self):
        ...
        self.spreadsheet = os.path.join(self.test_subdirectory, "spreadsheet.csv")
    ...
    def test_main(self):
        ...
        with flagsaver.flagsaver(template=self.template, spreadsheet=self.spreadsheet, output=output_filename):
