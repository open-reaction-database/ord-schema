...
class BuildDatasetTest(absltest.TestCase):
    def setUp(self):
        ...
        message_helpers.write_message(reaction1, os.path.join(self.test_subdirectory, "reaction-1.pbtxt"))
        # reaction2 is empty.
        reaction2 = reaction_pb2.Reaction()
        message_helpers.write_message(reaction2, os.path.join(self.test_subdirectory, "reaction-2.pbtxt"))
