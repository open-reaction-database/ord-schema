...
class Dataset(_message.Message):
    ...
    def __init__(
        ...
        reactions: _Optional[_Iterable[_Union[_reaction_pb2.Reaction, _Mapping]]] = ...,
        reaction_ids: _Optional[_Iterable[str]] = ...,
...
class DatasetExample(_message.Message):
    ...
    def __init__(
        ...
        description: _Optional[str] = ...,
        url: _Optional[str] = ...,
        created: _Optional[_Union[_reaction_pb2.RecordEvent, _Mapping]] = ...,
    ) -> None: ...
