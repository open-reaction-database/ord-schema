...
export namespace CompoundIdentifier {
  ...
  export interface CompoundIdentifierTypeMap {
    COMPOUND_IDENTIFIER_TYPE_UNSPECIFIED: 0;
    COMPOUND_IDENTIFIER_TYPE_CUSTOM: 1;
    COMPOUND_IDENTIFIER_TYPE_SMILES: 2;
    COMPOUND_IDENTIFIER_TYPE_INCHI: 3;
    COMPOUND_IDENTIFIER_TYPE_MOLBLOCK: 4;
    COMPOUND_IDENTIFIER_TYPE_IUPAC_NAME: 5;
    COMPOUND_IDENTIFIER_TYPE_NAME: 6;
    COMPOUND_IDENTIFIER_TYPE_CAS_NUMBER: 7;
    COMPOUND_IDENTIFIER_TYPE_PUBCHEM_CID: 8;
    COMPOUND_IDENTIFIER_TYPE_CHEMSPIDER_ID: 9;
    COMPOUND_IDENTIFIER_TYPE_CXSMILES: 10;
    COMPOUND_IDENTIFIER_TYPE_INCHI_KEY: 11;
    COMPOUND_IDENTIFIER_TYPE_XYZ: 12;
    COMPOUND_IDENTIFIER_TYPE_UNIPROT_ID: 13;
    COMPOUND_IDENTIFIER_TYPE_PDB_ID: 14;
    COMPOUND_IDENTIFIER_TYPE_AMINO_ACID_SEQUENCE: 15;
    COMPOUND_IDENTIFIER_TYPE_HELM: 16;
    COMPOUND_IDENTIFIER_TYPE_MDL: 17;
  }
